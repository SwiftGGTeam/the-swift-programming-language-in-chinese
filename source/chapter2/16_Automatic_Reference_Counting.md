...
-   [类实例间的强引用环](#strong_reference_cycles_between_class_instances)
-   [类实例间的强引用环分解](#resolving_strong_reference_cycles_between_class_instances)
-   [闭包的强引用环](#strong_reference_cycles_for_closures)
